"""Initial migration creating User, Recipe, CookingLog tables.

Revision ID: 825e35092fb6
Revises: 
Create Date: 2025-05-03 11:45:45.671012
...
def upgrade():
    ...
    sa.Column('date_cooked', sa.Date(), nullable=False),
